...
NDefines.NNavy.TRAINING_ACCIDENT_CHANCES = 0.00		
	...
	---------------------------------------------------------------
NDefines.NTechnology.LICENSE_PRODUCTION_TECH_BONUS = 0.0	-- WAS 0.2 | LICENSES ARE FREE SO TECH BONUS IS TOO MUCH | License production tech bonus
